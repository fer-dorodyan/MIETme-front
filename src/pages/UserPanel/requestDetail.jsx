...
// show contract detail and status
const RequestDetail = () => {
    ...
    useEffect(() => {
        ContractService.getRequestDetail(requestId)
            .then((res) => {
                setData(res.data);
            })
    ...
    function handleAccept() {
        ContractService.acceptRequest(requestId, textareaValue)
            .then((res) => {
    ...
    function handleReject() {
        ContractService.rejectedRequest(requestId, textareaValue)
            .then((res) => {
                    ...
                    {status === STATUS_ACCEPT && (
                        <div className="boxAccept">
                              <textarea
                                  ...
                                  placeholder="if you want something write it, and it will be added at the end of the contract"
                              />
                        </div>
                    )}
